...
| AVC考核核心算法_草稿.md | `docs/AVC考核核心算法_草稿.md` | ✅ **算法口径权威**（2026-08-13 Leo 拍板以此为准），含投运率(§一)+调节合格率(§二)+两档平行模型(§2.4–2.7)。草稿自述仍待真实数据定稿，但**判定口径以此为准**。v4.1 §8 把判定实现搁置为接口+stub |
...
- **后端落地**：`ruoyi-vqms` 模块、build/test 命令、真实数据验证均未开始（确定轨可立即推进 D1~D7，见 v4.1 §12.1）。
